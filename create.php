...
<main>
    <div class="container">
        ...
        <form class="col-md-6 offset-md-3 was-validated" method="POST" enctype="multipart/form-data">
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <div class="valid-feedback">Valid</div>
                <div class="invalid-feedback">Please fill your phone</div>
            </div>
            <div class="mb-3">
                <div class="row d-flex align-items-center">
                    <div class="col-md-3">
                        <label for="image" class="form-label">
                            <img src="/images/no-photo.png" alt="image" width="100%">
                        </label>
                    </div>
